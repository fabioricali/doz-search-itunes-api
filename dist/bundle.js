// [DozSearchItunesApi]  Build version: 1.0.6  
...
var _class = function (_Component) {
    ...
    _createClass(_class, [{
        ...
        value: function template(h) {
            ...
            //language=HTML
            return h(_templateObject, _dozSearchfield2.default, this.prepareSearch, this.clearSearch, this.props._isLoading, this.props._noResults, this.props._requestError, this.props.records.map(function (item) {
                return (
                    //language=html
        ...
        value: function search() {
            ...
            (0, _fetchJsonp2.default)(url, {
                ...
                _this2.props._isLoading = false;
                _this2.props._requestError = true;
                console.error(e);
            });
        }
    }, {
