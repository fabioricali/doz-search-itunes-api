...
var _dozSearchfield = __webpack_require__(12);
...
var _trackCard = __webpack_require__(33);
...
var _class = function (_Component) {
    ...
    _createClass(_class, [{
        ...
        value: function template(h) {
            ...
            //language=HTML
            return h(_templateObject, _dozSearchfield2.default, this.search, this.clearSearch, this.props.records.map(function (item) {
                return (
                    //language=html
                    h(_templateObject2, _trackCard2.default, item.artistName, item.trackName, item.artworkUrl100.replace('100x100', '300x300'))
                );
            }));
        }
    }, {
        ...
        value: function search(value) {
            ...
            _axios2.default.get(url).then(function (response) {
                _this2.props.records = response.data.results;
...
var TrackCard = function (_Component) {
    ...
    _createClass(TrackCard, [{
        ...
        value: function template(h) {
            //language=html
            return h(_templateObject, this.props.artworkUrl, this.props.artistName, this.props.artistName, this.props.trackName, this.props.trackName);
        }
    }]);
